...
http {
    ...
    server {
        ...
        location /open-static {
            track_request /auth-open-static;
        }
        ...
        location /unauthorized {
            track_request /auth-unauthorized;
        }
        ...
        location = /proxy-double-fallback {
            track_request /auth-proxy-double;
